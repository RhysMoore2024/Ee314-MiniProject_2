...
set_property PACKAGE_PIN U18 [get_ports {btn[4]}]   ;# CENTRE
set_property PACKAGE_PIN T18 [get_ports {btn[3]}]   ;# UP
set_property PACKAGE_PIN U17 [get_ports {btn[1]}]   ;# DOWN
set_property PACKAGE_PIN T17 [get_ports {btn[2]}]   ;# RIGHT
set_property PACKAGE_PIN W19 [get_ports {btn[0]}]   ;# LEFT
